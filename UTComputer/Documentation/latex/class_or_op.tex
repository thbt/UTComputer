\hypertarget{class_or_op}{}\section{Or\+Op Class Reference}
\label{class_or_op}\index{Or\+Op@{Or\+Op}}
Inheritance diagram for Or\+Op\+:\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[height=3.000000cm]{class_or_op}
\end{center}
\end{figure}
\subsection*{Public Member Functions}
\begin{DoxyCompactItemize}
\item 
void \hyperlink{class_or_op_a268ddceeb945b8d8e0de436a8833efdb}{operator()} (\hyperlink{class_stack}{Stack} $\ast$s)
...
\index{Or\+Op@{Or\+Op}!operator()@{operator()}}
\index{operator()@{operator()}!Or\+Op@{Or\+Op}}
\subsubsection[{\texorpdfstring{operator()(\+Stack $\ast$s)}{operator()(Stack *s)}}]{\setlength{\rightskip}{0pt plus 5cm}void Or\+Op\+::operator() (
\begin{DoxyParamCaption}
\item[{{\bf Stack} $\ast$}]{s}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}\hypertarget{class_or_op_a268ddceeb945b8d8e0de436a8833efdb}{}\label{class_or_op_a268ddceeb945b8d8e0de436a8833efdb}
